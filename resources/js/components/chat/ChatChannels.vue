<template>
    <span>
        <v-navigation-drawer v-model="prova" absolute temporary clipped width="900">
            <v-list class="pa-1">
                <v-list-tile avatar>
                    <v-list-tile-avatar>
            ...
            <v-layout row wrap class="mx-0">
                ...
                <v-flex xs12 class="scroll-y" style="max-height: calc(100vh - 64px - 64px - 64px - 64px)">
                    <v-list subheader>
                        ...
                        <v-list-tile v-for="channel in dataChannels" :key="channel.id" avatar @click="$emit('input',channel)">
                            <v-list-tile-avatar>
